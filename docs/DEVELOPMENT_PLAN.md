...
当前已完成 M2-A 至 M2-E：数据库已有版本化文档与 768 维向量模式；应用已有
Markdown/TXT 安全解析、400/64 Token 结构分块，并完成批量 Embedding、pgvector 写入、
同一文档原子版本替换、失败回滚和最小同步上传/状态/删除 API。PDF/DOCX/CSV 与在线向量检索尚未开始。
